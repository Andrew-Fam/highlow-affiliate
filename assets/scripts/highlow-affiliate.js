...
window.fullHeightHeroInit = function () {
	if($hero.length > 0){
		window.resizeHandler.addHandler(function (){
			...
			$('.hero-content').each(function(){
				var $header = $('header'),
					...
					if($(this).data('disableFullHeight')) {
						contentH = $realContentBlock.outerHeight()*1.2;
						heroH = $realContentBlock.outerHeight()*1.2;
					} else {
			...
			$('.hero-content.affiliate-login, .hero-content.affiliate-login .headline').css({
...
$(document).ready(function(){
	...
	waitForWebfonts(['Montserrat', 'Ek Mukta'], function() {
